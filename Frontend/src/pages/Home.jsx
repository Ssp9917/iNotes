...
const Home = () => {
  ...
  const { allNotes,loading } = useContext(MainContext);
                      ...
                      <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-[#f9f9f964]">
                        <div className="p-6">
                          ...
                          <p className="leading-relaxed mb-3 text-black">
                            ...
                            elit. Impedit rerum excepturi repellendus ex officia
                            iste, sit nobis doloribus voluptates ratione quis
                            accusamus sequi eius odio tempore assumenda ea
